...
$SCRIPTDIR/startBackup.sh -p $SCRIPTDIR/borg_passphrase_backup_box1_flo-data.txt -n $(hostname) -r ssh://$USER-sub1@$USER.your-storagebox.de:23/home/flo-data /tank/subvol-100-nas-flo
